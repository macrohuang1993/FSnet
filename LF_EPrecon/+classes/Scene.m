classdef Scene
    ...
    methods
        ...
        function parCheck(obj)
            cellfun( @(object) validateattributes(object, {'function_handle'}, {'ndims', 2}), obj.arg.objects );   % Cell array of function handles
            cellfun( @(position) validateattributes(position, {'numeric'}, {'size', [1, 3]}), obj.arg.positions );    % Cell array of 3d doubles
